...
A little handy mod that lets u see the horizontal, vertical and 
overall speed all at once!! 
Even configurable through the settings menu! <br>
---
### Note to users: 
This will lead to it being bugged when uninstalling 
...
Please report any bugs or any feature suggestions to the [GitHub repo](https://github.com/10-days-till-xmas/BetterSpeedometer/issues) 
or ping me on discord (`@10_days_till_xmas`)and I'll try to fix/add them as soon as possible!